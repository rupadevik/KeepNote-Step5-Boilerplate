...
public ResponseEntity<?> deleteNote(@PathVariable("userId") String userId,@PathVariable("noteId") int id) {
	...
	public ResponseEntity<?> updateNote(@PathVariable("userId") String userId, @PathVariable("noteId") int id, @RequestBody Note note) {
